...
public class OptimizerKernel
{
    ...
    var params: GrAI.Optimizer.Params! = nil
...
public class ConstEpochsScheduler: ConstEpochsTime, TimeScheduler
{
    ...
    ///
    public init(_ optimizer: GrAI.Optimizer.Class)
    {
...
public class ListEpochsScheduler: ListEpochsTime, TimeScheduler
{
    ...
    ///
    public init(epochs: [Int], optimizers: [GrAI.Optimizer.Class])
    {
...
class BuildOptimizer
{
    ...
    let _optimizerClass: GrAI.Optimizer.Class
    ...
    ///
    init(_ optimizerClass: GrAI.Optimizer.Class)
    {
