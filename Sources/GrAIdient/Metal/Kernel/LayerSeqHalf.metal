    ...
    uint2 id [[ thread_position_in_grid ]])
{
    ...
    half cosVal = rotationMatrix[2 * block + offset1];
    half sinVal = rotationMatrix[1 + 2 * block + offset1];
    
    half in1 = outsPrev[2 * block + offset2];
    half in2 = outsPrev[1 + 2 * block + offset2];
    ...
    uint2 id [[ thread_position_in_grid ]])
{
    ...
    half out1 = delta[2 * block + offset2];
    half out2 = delta[1 + 2 * block + offset2];
